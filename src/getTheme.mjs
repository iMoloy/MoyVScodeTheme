export default colors => ({
  ...
  colors: {
    ...
    'list.focusBackground': colors.background4,
    'list.focusForeground': colors.pure2,
    'list.highlightForeground': colors.pure2,
    'list.hoverBackground': colors.background3,
    ...
    'list.inactiveFocusBackground': colors.background1,
    'list.invalidItemForeground': colors.base1,
    'activityBar.background': colors.background3,
    'activityBar.dropBackground': colors.translucent,
    'activityBar.foreground': colors.dim3,
    'activityBar.border': colors.dim1,
    ...
    'tab.unfocusedHoverBorder': colors.dim1,
    'editor.background': colors.background3,
    'editor.foreground': colors.pure2,
    'editorLineNumber.foreground': colors.background4,
    ...
    'statusBar.background': colors.background3,
    'statusBar.foreground': colors.dim2,
    'statusBar.border': colors.dim1,
    'statusBar.debuggingBackground': colors.dim2,
    'statusBar.debuggingForeground': colors.pure2,
    'statusBar.debuggingBorder': colors.dim1,
    'statusBar.noFolderBackground': colors.background2,
    'statusBar.noFolderForeground': colors.dim2,
    'statusBar.noFolderBorder': colors.dim1,
    'statusBarItem.activeBackground': colors.background1,
    'statusBarItem.hoverBackground': colors.background1,
    ...
    'notifications.background': colors.background3,
    'notifications.border': colors.background4,
    'notificationLink.foreground': colors.base2,
    'extensionButton.prominentForeground': colors.background3,
    'extensionButton.prominentBackground': colors.accent2,
    'extensionButton.prominentHoverBackground': colors.accent2light,
